...
Route::get('/msg', 'HomeController@msg')->name('msg')->middleware('auth');
...
Route::group(['prefix'=>'seller','middleware'=>'auth'],function(){
 ...
 Route::get('/payment/show/expense/{particular}','Seller\PaymentController@showExpense')->name('seller.payment.show.expense');
  ...
  Route::get('/payment/show/advertise/{particular}','Seller\PaymentController@showAdvertise')->name('seller.payment.show.advertise');
