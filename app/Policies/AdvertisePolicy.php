...
//let only exact seller to read 
    ...
    public function read(User $user, Advertise $advertise)
    {
        if(empty($advertise->shop)){
            return false;
        }
        return $user->id==$advertise->shop->user_id;
    }
    
    public function edit(User $user, Advertise $advertise)
    {
        if(empty($advertise->shop)){
            return false;
        }
