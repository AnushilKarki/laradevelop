...
class PaymentController extends Controller
{
 ...
 //Return of particular seller
    ...
    //Advertise of particular seller
            $advertises=Advertise::whereHas('shop',function($q){
                $q->where('user_id',auth()->id());
            })->get();
   
        return view('sellers.payments.index',compact('assets','capitals','liabilities','advertises','incomes','expenses','purchases','returns'));
...
$particulars = DB::table('liabilities')->where('id', $particular)->get();
 ...
 public function showReturn($particular)
  ...
  $paymentfor='return';
    ...
    public function showAdvertise($particular)
    {
    //  $items=$order->items()->whereHas('shop',function($q){
    //      $q->where('user_id',auth()->id());
    //  })->get();
  $particulars = DB::table('advertises')->where('id', $particular)->get();
...
{
$payment->advertise_id = $request->input('id');
}
else
{
